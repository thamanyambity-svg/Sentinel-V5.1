...
int OnInit()
{
   ...
   LoadWatermarks();
   Print("🏰 SENTINEL V4.2: FULL ARMOR + ROBUST PARSER");
...
void OnTimer()
{
   ...
   ScanForCommands();
   ManageRisk(); // <--- CRITICAL: Risk Management Active
   BroadcastStatus();
   GenerateDashboard();
}
...
// THIS WAS MISSING IN V4.1 AND CAUSED THE "RED" TRADES!
void ManageRisk()
{
...
void GenerateDashboard()
{
   ...
   string html = "<!DOCTYPE html><html><head><title>Sentinel V4.2 Dashboard</title>";
